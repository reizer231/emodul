...
payload_outside = {"state":temp_outside, "attributes": {"state_class": "measurement", "unit_of_measurement": "\u00b0C", "device_class": "temperature", "friendly_name": "Temperatura na zewnątrz"}}
payload_cwu = {"state":temp_cwu, "attributes": {"state_class": "measurement", "unit_of_measurement": "\u00b0C", "device_class": "temperature", "friendly_name": "Temperatura CWU"}}
payload_co = {"state":temp_co, "attributes": {"state_class": "measurement", "unit_of_measurement": "\u00b0C", "device_class": "temperature", "friendly_name": "Temperatura Pieca"}}
payload_exhaust = {"state":temp_exhaust, "attributes": {"state_class": "measurement", "unit_of_measurement": "\u00b0C", "device_class": "temperature", "friendly_name": "Temperatura Spalin"}}
